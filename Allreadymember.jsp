...
<html>
    <head>
        ...
        <title>Sorry For the Inconvenience | CarPool</title>
    ...
    <body>
        ...
        <div class="alert alert-warning alert-dismissable" >
            <center><b><font size="20">We are sorry for the inconvenience but you are either already a member of this group or this carpool is posted by you.</font></b></center>
            <br>           
            <center>
                    <a href="searchride.jsp"><button class="btn btn-primary btn-lg btn-success">CLICK &nbsp; &nbsp; TO &nbsp; &nbsp;CONTINUE</button></a>
            </center>
        </div>
    </body>
</html>