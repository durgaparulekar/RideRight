...
<html>
    <head>
        <title>Ride Search | RideRight</title>
            ...
            function load(url,callback) {
                ...
                var idx = document.URL.indexOf('?');
                    ...
                    var pairs = document.URL.substring(idx+1, document.URL.length).split('&');
                        ...
                        params = getParams();
                        tripsource = unescape(params["FromInput"]);
                          tripdestination = unescape(params["ToInput"]);
                            tripdate=unescape(params["tripdate"]);
                
              window.onload = function () {
                 var url = "GetSpecific.jsp?FromInput="+tripsource+ "&ToInput=" +tripdestination+ "&tripdate="+tripdate;
