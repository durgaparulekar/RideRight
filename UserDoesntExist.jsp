...
<html>
    <head>
        ...
        <title>User Login Not Recognized | RideRight</title>
    ...
    <body>
        ...
        <div class="alert alert-warning alert-dismissable" >
            <center><b><font size="20">We are sorry for the inconvenience,but either the Email ID or the password is incorrect.<br>Please try logging in again.</font></b></center>
            <br><br>            
            <center>
                    <a href="login.jsp"><button class="btn btn-primary btn-lg btn-success">CLICK &nbsp; &nbsp; TO &nbsp; &nbsp;CONTINUE</button></a>
            </center>
        </div>
