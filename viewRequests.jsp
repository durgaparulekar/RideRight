...
<html>
    ...
    <head>
        <title>View Ride Requests| RideRight</title>
        ...
        <link rel="stylesheet" href="css/jquery-ui-1.10.0.custom.min.css">  
         ...
         <script type="text/javascript">
              ...
              window.onload = function () {
                load('requests.jsp',function(response){
                  document.getElementById("rides").innerHTML = response;
                });
            ...
            function load(url,callback) {
                document.getElementById("view1").onclick = function() {
                    location.href = "GetPassenger.jsp?id=" + butt;
                }; 
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title" id="myModalLabel">View Passenger !</h4>
                    </div>
                    <div class="modal-body">
                        <p>Are you sure you want to view this Passenger's Request?</p>
