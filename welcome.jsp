...
<html>
    <head>
      ...
      <script type="text/javascript" src="https://netdna.bootstrapcdn.com/bootstrap/3.0.0/js/bootstrap.min.js"></script>
        ...
        <script type="text/javascript">
            ...
            function load(url,callback) {
                ...
                document.getElementById("view1").onclick = function() {
                 ...
                 document.getElementById("delbutt2").onclick = function() {
                    location.href = "DeleteRideRequest.jsp?butt=" + butt2;
                };
                var xmlhttp;
        ...
        <%}%>
         <% int dele2 = request.getParameter("del2") == null ? 0 : Integer.parseInt(("" + request.getParameter("del2")).trim());
            if (dele2 == 1) {
        %>
        <script type="text/javascript">
            $(window).load(function() {
                $('#DeletedModal2').modal('show');
            });
        </script>
        <%}%>
        <script type="text/javascript">
...
//         result += parkingCost * noOfDays;
    ...
    <body >       
       ...
       <div class="modal fade" id="DeletionModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <p>Are you sure you wanna Delete this Car Pool?</p>
        ...
        <div class="modal fade" id="DeletedModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <p>The Car Pool Has Been Deleted !!!</p>
        ...
        <div class="modal fade" id="ViewModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-hidden="true"><i class="glyphicon glyphicon-remove"></i></button>
                        <h4 class="modal-title" id="myModalLabel">View Car Pool !</h4>
                    </div>
                    <div class="modal-body">
                        <p>Do you wanna see this Car Pool Ride?</p>
        ...
        <div class="modal fade" id="DeletionModal2" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-hidden="true"><i class="glyphicon glyphicon-remove"></i></button>
                        <h4 class="modal-title" id="myModalLabel">Delete Car Pool Request !</h4>
                    </div>
                    <div class="modal-body">
                        <p>Are you sure you wanna Delete this Car Pool Request?</p>
                        <button id="delbutt2" class="btn btn-success btn-lg" data-dismiss="modal"><i class="glyphicon glyphicon-ok-sign"></i>&nbsp;&nbsp;YES</button>
                        <button type="button" class="btn btn-default btn-lg" data-dismiss="modal"><i class="glyphicon glyphicon-remove-sign"></i>&nbsp;&nbsp;NO</button>
                    </div>      
                </div>
            </div>
        </div>  
        <div class="modal fade" id="DeletedModal2" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-hidden="true"><i class="glyphicon glyphicon-remove"></i></button>
                        <h4 class="modal-title" id="myModalLabel">Deleted Car Pool Request!</h4>
                    </div>
                    <div class="modal-body">
                        <p>The Car Pool Request Has Been Deleted !!!</p>
                        <a href="welcome.jsp"><button type="button" class="btn btn-success btn-lg" data-dismiss="modal">OK</button></a>
                    </div>      
                </div>
            </div>
