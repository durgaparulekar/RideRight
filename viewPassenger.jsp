...
<html>
    ...
    <head>
        <title>View Ride Request| RideRight</title>
   ...
   <script src="http://maps.google.com/maps/api/js?sensor=true"></script>
    ...
    function load(url,callback) {
                document.getElementById("view1").onclick = function() {
                    location.href = "rideconfirmation.jsp?id=" + butt;
                }; 
                document.getElementById("delbutt").onclick = function() {
                    location.href = "declineconfirmation.jsp?id=" + v;
                };
                var xmlhttp;
...
//         result += parkingCost * noOfDays;
    ...
    <body>
            ...
            <div class="col-md-7 col-md-push-1">
                <div class="container1">
                    ...
                    <div>
                                                  <div id="p"></div>
                        <BR>
                         <p id="driver">     Passenger       : <%="" + request.getParameter("name")%></p>
                        <p id="">       Year         : <%="" + request.getParameter("yearr")%></p>                        
                       <p id="">          Course         : <%="" + request.getParameter("course")%></p> 
                        <p id="driver">  Faculty:  <%="" + request.getParameter("faculty")%></p>
                        <p id="driverEmail">Gender        : <%="" + request.getParameter("gender")%></p>
                       ...
                       <p id="">          To         : <%="" + request.getParameter("tripdestination")%></p> 
                        ...
                        <p id="etime">      Date     : <%="" + request.getParameter("tripdate")%></p>
                         ...
                         <p id="etime">      Userid     : <%="" + request.getParameter("userid")%></p>
                         <p id="etime">      Tripid     : <%="" + request.getParameter("tripid")%></p>
                         <form method="post" action="rideconfirmation.jsp">
         <input type="hidden" id="userid" name="userid"  value="<%= ""+request.getParameter("userid")%>"size="30" />    
        <input type="hidden" id="tripid" name="tripid"  value="<%=""+ request.getParameter("tripid")%>"size="30" />    
 
               <button type="submit" class="btn btn-lg btn-success" >
                            Accept
   </button><br><br>
                         </form>
                         <form method="post" action="declineconfirmation.jsp">
         <input type="hidden" id="userid" name="userid"  value="<%= ""+request.getParameter("userid")%>"size="30" />    
        <input type="hidden" id="tripid" name="tripid"  value="<%=""+ request.getParameter("tripid")%>"size="30" />    
      ...
      <button type="button" class="btn btn-lg btn-success" onclick="window.location.href='viewRequests.jsp'">
                            Go Back
                        </button><br> <br><br>          
                         </form>                     
                </div>
