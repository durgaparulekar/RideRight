<%-- 
    ...
    Created on : Jan 9, 2018, 12:07:57 AM
    Author     : admin
--%>
...
<tr>
    <td></td>
    <td><font size=5><input type="checkbox" name="faculty" value="faculty" checked><font size=5> Faculty<br></font></td>
...
<td><font size=4><select required name="department" style="width:200px " >
...
<td><input maxlength="3" type="text" name="age" id="age" size="2" style="height:30px; width:200px; " onkeypress="return backspaceAlpha(event)" required></td>
</tr>
...
<tr>
    <td><font size=5>Upload Image: </td>
